...
// ✅ Decrypt AES key (Meta expects RSA-OAEP with SHA-256)
...
function decryptPayload(encryptedData, aesKey, iv) {
  ...
  decipher.setAuthTag(Buffer.alloc(16)); // or use real tag if provided
...
// ✅ Send diamond as image + button card
